    ...
    var command =
        switch (action) {
          ...
          case LIST -> new CommandListEmail(
              JsonHelper.fromJsonNode(
                  parameters, CommandListEmail.CommandListEmailParameter.class));
          case READ -> new CommandReadEmail(
              JsonHelper.fromJsonNode(
                  parameters, CommandReadEmail.CommandReadEmailParameter.class));
          case SEND -> new CommandSendEmail(
              JsonHelper.fromJsonNode(
                  parameters, CommandSendEmail.CommandSendEmailParameter.class));
