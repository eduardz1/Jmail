...
class ServerTest {
    ...
    void testCreateNewUser() {
        ...
        edu1.setPasswordSHA256(Hashing.sha256().hashString("edu1", StandardCharsets.UTF_8).toString());

        var edu2 = new User();
        edu2.setEmail("eduard.occhipinti@edu.unito.it");
        edu2.setName("Eduard");
        edu2.setSurname("Occhipinti");
        edu2.setPasswordSHA256(Hashing.sha256().hashString("edu2", StandardCharsets.UTF_8).toString());
        ...
        fratta.setPasswordSHA256(Hashing.sha256().hashString("fratta", StandardCharsets.UTF_8).toString());
