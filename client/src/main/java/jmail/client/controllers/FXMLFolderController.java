...
public class FXMLFolderController extends AnchorPane {
    ...
    private void initListeners() {
        ...
        listFolder.getSelectionModel().selectedItemProperty().addListener((observable, oldValue, newValue) -> DataModel.getInstance().setCurrentFolder(newValue.toLowerCase()));
